...
public class PizzaMain {
	...
	private void inputToppingChoices() {
		...
		for (Integer i = 0; i < numToppings; i++) {
			...
			System.out.println("5 - Green Onions");
			System.out.println("6 - Olives");
			System.out.println("7 - Pepper");
			System.out.println("8 - Mushroom");
			System.out.println("9 - Mozzarella");
			System.out.println("10 - Parmesan");
			System.out.println("11 - Asiago");
			System.out.println("12 - Chedder");
			System.out.print("Your choice: ");
			while (!validChoice) {
				Integer choice = input.nextInt();
				switch(choice) {
					...
					case 11: 
						...
						break;
					case 12: 
						pizza.addTopping(new ChedderTopping());
						validChoice = true;
						break;
					default:
